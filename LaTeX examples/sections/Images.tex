...
Para incluir una imagen hay que utilizar el comando \verb!\includegraphics{./images/nombre}!, ./images/ es el directorio donde está guardada su imagen y "nombre" es el nombre con el que está guardada de la imagen.
