...
\begin{longtable}[H]{p{1.7cm} >{\raggedright\arraybackslash}p{2.8cm} p{2cm} p{2cm} p{4.1cm} }
	\toprule[2pt]
...
\begin{longtable}[H]{>{\raggedright\arraybackslash}p{3.7cm} >{\raggedright\arraybackslash}p{1.7cm} >{\raggedright\arraybackslash}p{3cm} p{5cm}}
	
	\toprule[2pt]
	
	\textbf{Description of risk} & \textbf{Level of Likelihood} & \textbf{Work package(s) involved} & \textbf{Proposed risk-mitigation measure} \\
