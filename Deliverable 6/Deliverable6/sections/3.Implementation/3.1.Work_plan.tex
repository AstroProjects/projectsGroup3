...
\begin{longtable}[H]{p{1.8cm} p{2cm} p{1.3cm} p{1.8cm} p{1.3cm} p{2.1cm} p{1.8cm}}
	...
	D1.1 & Project Management Plan & WP1 & HR & R & CO & month 1  \vspace{0.2cm} \\
	
	\midrule

	D6.1 & Business Plan & WP6 &  &  &  & month 1  \vspace{0.2cm} \\
	
	\midrule
	
	D7.1 & Communication Plan & WP7 &  &  &  & month 1  \vspace{0.2cm} \\

	\midrule

 	D3.1 & Payload State of the Art & WP3 &  &  &  & month 4  \vspace{0.2cm} \\

 	\midrule

	D3.2 & Modular System State of the Art  & WP3 &  &  &  & month 4  \vspace{0.2cm} \\
	
	\midrule
	
	D3,3 & Space Applications State of the Art & WP3 &  &  &  & month 4 \vspace{0.2cm} \\

	\midrule

 	D7 & Payload Preliminary Design  & WP4 &  &  &  & month  \vspace{0.2cm} \\

 	\midrule

	D8 & Modular System Preliminary Design & WP4 &  &  &  &month  \vspace{0.2cm} \\
	
	\midrule
	
	D9 & Interaction Platform Preliminary Design  & WP4 &  &  &  & month  \vspace{0.2cm} \\

	\midrule

 	D10 & Payload Final Design & WP4 &  &  &  & month  \vspace{0.2cm} \\

 	\midrule

	D11 & Modular System  Final Design  & WP4 &  &  &  &month  \vspace{0.2cm} \\
	
	\midrule
	
	D12 & Sensors Data Fusion Software Report  & WP4 &  &  &  & month  \vspace{0.2cm} \\

	\midrule

 	D13 & Interaction Platform Final Desing  & WP4 &  &  &  & month  \vspace{0.2cm} \\

 	\midrule

	D14 & Data Processing Software Report & WP4 &  &  &  &month  \vspace{0.2cm} \\
	
	\midrule
	
	D15 & Validation Report & WP5 &  &  &  & month  \vspace{0.2cm} \\

	\midrule

 	D16 & Final Report &  &  &  &  & month  \vspace{0.2cm} \\
