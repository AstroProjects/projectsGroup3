...
\begin{table}[H]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{3cm} >{\arraybackslash}p{11cm}}
		...
		Procurement metrics & Monthly development progress reports, detailing how much of each sensor have been developed as a \%. Undersanding that 100\% progress is the delivery of the sensor. \vspace{0.2cm} \\
...
\begin{table}[H]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{3cm} >{\arraybackslash}p{11cm}}
		...
		Procurement metrics & Monthly development progress reports, detailing how much of the modular system have been developed as a \%. Undersanding that 100\% progress is the delivery of the modular system. \vspace{0.2cm} \\
...
\begin{table}[H]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{3cm} >{\arraybackslash}p{11cm}}
		...
		Procurement metrics & Monthly quality ystudy progress reports, detailing how much of each qualifying test have been perform as a \%. Also, an other \% parameter, indicating the operability of each tested system. \vspace{0.2cm} \\
...
\begin{table}[H]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{3cm} >{\arraybackslash}p{11cm}}
		...
		Procurement metrics & \% parameter indicating, how much of the final platform have been implemented. A ranking parameter indicating the visibility of the website on internet search engines.\vspace{0.2cm} \\
