...
\begin{table}[H]
	...
	\begin{tabular}{| >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{5.1cm} |}
		...
		\textbf{Number and Type of Resources Required:} \newline 3	Application development technician	&	\textbf{Skill Requirements:} \newline Average \newline Novice	&	\textbf{Other Required Resources:} \newline 1	Development centre \newline 1	Interaction platform building block	\\ 
...
\begin{table}[H]
	...
	\begin{tabular}{| >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{5.1cm} |}
		...
		\textbf{Number and Type of Resources Required:} \newline 4	System testing engineer	&	\textbf{Skill Requirements:} \newline Expert \newline Average \newline Novice	&	\textbf{Other Required Resources:} \newline 5	Testing room \newline 1	Payload building block	\\ 
...
\begin{table}[H]
	...
	\begin{tabular}{| >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{5.1cm} |}
		...
		\textbf{Number and Type of Resources Required:} \newline 2	Application development engineer	&	\textbf{Skill Requirements:} \newline Expert \newline Average	&	\textbf{Other Required Resources:} \newline 1	Testing room \newline 1	Interaction platform building block	\\ 
...
\begin{table}[H]
	...
	\begin{tabular}{| >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{5.1cm} |}
		...
		\textbf{Number and Type of Resources Required:} \newline 2	System testing engineer \newline 2	Application development technician \newline 2	System development engineer	&	\textbf{Skill Requirements:} \newline Average	&	\textbf{Other Required Resources:} \newline 1	Testing room \newline 1	Payload building block \newline 1	Modular building block \newline 1	Interaction platform building block	\\ 
