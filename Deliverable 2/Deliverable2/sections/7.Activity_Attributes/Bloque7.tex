...
\begin{table}[H]
	...
	{| >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{5.1cm} |}
		...
		\multicolumn{3}{| >{\raggedright\arraybackslash}p{13.7cm} |}{\textbf{Constraints: } \newline Due date Deliverable Communication plan: 05/10/18 \newline Due date Milestone Communication plan: 05/10/18}	\\ 
...
\end{table}
 ...
 \begin{table}[H]
 	...
 	\begin{tabular}{| >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{4.3cm} | >{\raggedright\arraybackslash}p{5.1cm} |}
 		...
 		\multicolumn{3}{| >{\raggedright\arraybackslash}p{13.7cm} |}{\textbf{Constraints:} \newline Due date Deliverable Communication plan: 21/01/22 \newline Due date Milestone Communication plan: 21/01/22}	\\ 
