...
\begin{itemize}
\item Senior: High on the learning curve. Is able to provide guidance on technical and management issues and offers a critical point of view of the actions of the project.
\item Average:Is able to perform activities on its knowledge field and arrive to conclusions without supervision. 
\item Junior: Little experience in the field, the work done need to be supervised by an average employee. 
\end{itemize}
