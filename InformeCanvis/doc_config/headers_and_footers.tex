...
%-----------------------------------------------
	% Headers
	\fancyhead[LO]{\textbf{Reporting Changes}} % Section mark
	\fancyhead[RO]{\includegraphics[height=25pt]{./doc_config/images/logo3}}
	\fancyhead[LE]{\textbf{Reporting Changes}}
	\fancyhead[RE]{\includegraphics[height=25pt]{./doc_config/images/logo3}}
